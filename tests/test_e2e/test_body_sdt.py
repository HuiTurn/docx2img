"""Body content controls expose their visible static content."""
...
from tests.fixtures.gen_fixtures import make_body_sdt


def test_body_sdt_content_reaches_model_layout_and_pixels(tmp_path, caplog):
    docx = make_body_sdt(tmp_path / "body_sdt.docx")
