...
def make_header_sdt(path: Path) -> Path:
    """One-page document with a block-level header content control."""
    header_xml = f"""<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<w:hdr xmlns:w="{NS_W}">
  <w:sdt>
    <w:sdtPr>
      <w:alias w:val="Header label"/>
      <w:tag w:val="header-label"/>
      <w:text/>
    </w:sdtPr>
    <w:sdtContent>
      <w:p>
        <w:pPr><w:jc w:val="center"/></w:pPr>
        {_run("Controlled header", bold=True, color="2F5496")}
      </w:p>
    </w:sdtContent>
  </w:sdt>
</w:hdr>"""
    ...
    body = _para(_run("Header content control fixture.", bare=True)) + sect
    return write_docx(
        path,
        _document(body),
        extra_rels=rels,
...
def make_header_alternate_content(path: Path) -> Path:
    """One-page document with a block-level header compatibility choice."""
    header_xml = f"""<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<w:hdr xmlns:w="{NS_W}" xmlns:mc="{NS_MC}">
  <mc:AlternateContent>
    <mc:Choice Requires="w">
      <w:p>
        <w:pPr><w:jc w:val="center"/></w:pPr>
        {_run("Alternate header choice", bold=True, color="2F5496")}
      </w:p>
    </mc:Choice>
    <mc:Fallback>
      <w:p>
        <w:pPr><w:jc w:val="center"/></w:pPr>
        {_run("Alternate header fallback", bold=True, color="C00000")}
      </w:p>
    </mc:Fallback>
  </mc:AlternateContent>
</w:hdr>"""
    ...
    body = _para(_run("Header alternate-content fixture.", bare=True)) + sect
    return write_docx(
        path,
        _document(body),
        extra_rels=rels,
...
<w:sdt>
  <w:sdtPr>
    <w:alias w:val="Body label"/>
    <w:tag w:val="body-label"/>
    <w:text/>
  </w:sdtPr>
  <w:sdtContent>
    <w:p>
      <w:pPr><w:jc w:val="center"/></w:pPr>
      {_run("Controlled body", bold=True, color="2F5496")}
    </w:p>
  </w:sdtContent>
</w:sdt>"""
    sect = (
...
def make_hyperlink_complex_field(path: Path) -> Path:
    """One-page footer with a cached complex HYPERLINK field result."""
    footer_xml = f"""<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<w:ftr xmlns:w="{NS_W}">
  <w:p>
    <w:pPr><w:jc w:val="center"/></w:pPr>
