...
OFFICE_CASES = {
    ...
    "footnote_line_continuation": "footnote_line_continuation.docx",
    "footnote_multiple_continuation": "footnote_multiple_continuation.docx",
    "footnote_reflow": "footnote_reflow.docx",
    "footnote_wrap_continuation": "footnote_wrap_continuation.docx",
    "header_alternate_content": "header_alternate_content.docx",
    "header_custom_xml": "header_custom_xml.docx",
    "header_sdt": "header_sdt.docx",
    "header_table": "header_table.docx",
    "hyperlink_field": "hyperlink_field.docx",
    "hyperlink_complex_field": "hyperlink_complex_field.docx",
    "math_accent": "math_accent.docx",
    "math_bar": "math_bar.docx",
    "math_border_box": "math_border_box.docx",
    "math_eq_arr": "math_eq_arr.docx",
...
def _ensure_office_fixture(case: str, docx: Path) -> None:
    ...
    from fixtures.gen_fixtures import (
        ...
        make_header_alternate_content,
        make_header_custom_xml,
        make_header_sdt,
        make_header_table,
        make_hyperlink_field,
        make_hyperlink_complex_field,
        make_math_accent,
        make_math_bar,
    ...
    builders = {
        ...
        "footnote_line_continuation": make_footnote_line_continuation,
        "footnote_multiple_continuation": make_footnote_multiple_continuation,
        "footnote_reflow": make_footnote_reflow,
        "footnote_wrap_continuation": make_footnote_wrap_continuation,
        "header_alternate_content": make_header_alternate_content,
        "header_custom_xml": make_header_custom_xml,
        "header_sdt": make_header_sdt,
        "header_table": make_header_table,
        "hyperlink_field": make_hyperlink_field,
        "hyperlink_complex_field": make_hyperlink_complex_field,
        "math_accent": make_math_accent,
        "math_bar": make_math_bar,
        "math_border_box": make_math_border_box,
        "math_eq_arr": make_math_eq_arr,
